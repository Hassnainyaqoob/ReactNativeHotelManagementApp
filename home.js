    ...
    <View style={{ flex: 1, backgroundColor: "white" }}>
      ...
      <ImageBackground source={image} style={{ width: "100%", height: "100%" }}>
        ...
        <ScrollView>
          ...
          <View style={{ marginTop: 46, backgroundColor: "white", }}>


            <View style={{ flexDirection: 'row', flex: 1, marginTop: 30 }}>
              <View style={{ flex: 1, marginHorizontal: 3, marginBottom: 90 }}>
            ...
            <View style={{ marginTop: 30, width: 130, borderColor: "black", alignSelf: "center", marginLeft: 10, marginBottom: 10 }}>
              <TouchableOpacity style={{ backgroundColor: "darkorange", width: 125, height: 40, borderRadius: 20, }} onPress={applyFilterHandle}>
